...
class Notification {
	...
	public ArrayList<String> getNtfcTargetUser() {
		return ntfcTargetUser;
	}

	public void setNtfcTargetUser(ArrayList<String> ntfcTargetUser) {
		this.ntfcTargetUser = ntfcTargetUser;
	}
	...
	public int getTaskOwnerIdx() {
		return taskOwnerIdx;
	}

	public void setTaskOwnerIdx(int taskOwnerIdx) {
		this.taskOwnerIdx = taskOwnerIdx;
	}

	public int getNtfcSenderIdx() {
		return ntfcSenderIdx;
	}

	public void setNtfcSenderIdx(int ntfcSenderIdx) {
		this.ntfcSenderIdx = ntfcSenderIdx;
	}

	public int getNtfcTableIdx() {
		return ntfcTableIdx;
	}

	public void setNtfcTableIdx(int ntfcTableIdx) {
		this.ntfcTableIdx = ntfcTableIdx;
	}

	public String getNtfcSenderName() {
		return ntfcSenderName;
	}

	public void setNtfcSenderName(String ntfcSenderName) {
		this.ntfcSenderName = ntfcSenderName;
	}

	public String getNtfcTableName() {
		return ntfcTableName;
	}

	public void setNtfcTableName(String ntfcTableName) {
		this.ntfcTableName = ntfcTableName;
	}

	public String getNtfcMessage() {
		return ntfcMessage;
	}

	public void setNtfcMessage(String ntfcMessage) {
		this.ntfcMessage = ntfcMessage;
	}

	public Map<String, Object> getNtfcMetaInfo() {
		return ntfcMetaInfo;
	}

	public void setNtfcMetaInfo(Map<String, Object> ntfcMetaInfo) {
		this.ntfcMetaInfo = ntfcMetaInfo;
	}

	public NotificationType getNtfcType() {
		return ntfcType;
	}

	public void setNtfcType(NotificationType ntfcType) {
